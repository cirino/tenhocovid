...
!function(){
	try{document.getElementsById("top-1")[0].getElementsByTagName("a")[0].removeAttribute("rel")
}catch(b){}
...
// 	a.innerHTML='<a href="https://mobirise.in">Mobirise Easy Website Builder</a> Mobirise v5.1.4';document.body.insertBefore(a, document.body.childNodes[0])
// }
}();
